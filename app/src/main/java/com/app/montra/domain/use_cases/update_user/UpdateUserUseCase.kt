...
import com.app.montra.data.remote.dto.UpdateUserResponseDto
...
class UpdateUserUseCase @Inject constructor(
    ...
    operator fun invoke(userId: String, requestBody: UpdateUserRequest): Flow<Resource<UpdateUserResponseDto>> = flow {
        try {
